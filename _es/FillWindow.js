...
var FillWindow = function (_React$Component) {
  ...
  function FillWindow() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.updateDimensions = debounce(function () {
