...
exports.default = function (nameOrFragment) {
  ...
  var pluralRecordType = (0, _pluralize2.default)(recordType);
  /*eslint-disable*/
  ...
  return (0, _reactApollo.graphql)(deleteByIdsMutation, _extends({
    props: function props(_ref) {
      ...
      function deleteMutation() {
        ...
        return mutate(_extends({
          ...
          update: update || (0, _invalidateQueriesOfTypes2.default)([pluralRecordType]),
      ...
      }, _toReturn[(0, _lodash.camelCase)("delete_" + recordType)] = deleteMutation, _toReturn);
      if (mutationName) {
