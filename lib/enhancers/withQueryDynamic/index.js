...
function withQuery(__inputFragment, maybeOptions) {
  ...
  return function (Component) {
    return function (props) {
      ...
      var gqlQuery = (0, _generateQuery2.default)(fragment, mergedOpts);
      ...
      if ((0, _lodash.get)(variablesToUse, "filter.entity") && (0, _lodash.get)(variablesToUse, "filter.entity") !== modelName) {
      ...
      return _react2.default.createElement(
        ...
        _extends({
          query: gqlQuery
        }, !(0, _lodash.isEmpty)(variablesToUse) && { variables: variablesToUse }, {
        ...
        function (_ref) {
          ...
          }, _extends2[nameToUse] = results, _extends2["error" + (0, _lodash.upperFirst)(nameToUse)] = data.error, _extends2["loading" + (0, _lodash.upperFirst)(nameToUse)] = data.loading, _extends2));
          ...
          return _react2.default.createElement(Component, _extends({}, allPropsForComponent, (0, _lodash.isFunction)(mapQueryProps) && mapQueryProps(allPropsForComponent)));
        }
      );
    };
  };
