...
var _invalidateQueriesOfTypes = require("../utils/invalidateQueriesOfTypes");

var _invalidateQueriesOfTypes2 = _interopRequireDefault(_invalidateQueriesOfTypes);
...
function withUpsert(nameOrFragment) {
  ...
  /* eslint-disable */
  var createMutation = (0, _graphqlTag2.default)(_templateObject, createName, createName, createName, fragName ? "..." + fragName : idAs || "id", fragment ? fragment : "");
  /* eslint-enable */

  var updateName = "update" + pascalCaseName;
  /* eslint-disable */
  var updateMutation = (0, _graphqlTag2.default)(_templateObject2, updateName, updateName, updateName, fragName ? "..." + fragName : idAs || "id", fragment ? fragment : "");
  /* eslint-enable */
  ...
  var getExtraMutateArgs = function getExtraMutateArgs() {
    ...
    if (invalidate) {
      ...
      extraArgs = { options: (0, _invalidateQueriesOfTypes2.default)(invalidate) };
    }
  ...
  return (0, _compose2.default)((0, _reactApollo.graphql)(createMutation, _extends({
    name: "createItem",
  ...
  }, rest)), (0, _reactRedux.connect)(function (state, ownProps) {
    var _ref6;
