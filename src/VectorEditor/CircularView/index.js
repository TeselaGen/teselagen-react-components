...
export default class CircularView extends React.Component {
  getNearestCursorPositionToMouseEvent(event, sequenceLength, callback) {
    ...
    var nearestCaretPos = normalizePositionByRangeLength(
  ...
  render() {
    ...
    var { features: showFeatureLabels = true } = annotationLabelVisibility;
    var {
    ...
    function drawFeatures() {
      //DRAW FEATURES
      if (showFeatures) {
        var [annotationsToPass, paredDown] = pareDownAnnotations(
