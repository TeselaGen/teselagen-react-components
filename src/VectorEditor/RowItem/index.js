...
class RowItem extends React.Component {
  render() {
    ...
    var deletionLayersToDisplay = flatMap(
    ...
    var deletionLayerStrikeThrough = deletionLayersToDisplay.length
      ? deletionLayersToDisplay.map(function(layer) {
    ...
    return (
      ...
      >
        ...
        {map(replacementLayers, function(replacementLayer) {
          ...
          var layerRangeOverlaps = getOverlapsOfPotentiallyCircularRanges(
            insertedBpsLayer,
            row,
            sequenceLength
          );
