...
export function useToggle({
  ...
  useEffect(() => {
    const editorDemoState = getCurrentParamsFromUrl(window.location);
    console.log(`editorDemoState`, editorDemoState)
    ...
    console.log(`massagedEditorDemoState`, massagedEditorDemoState)
  })
