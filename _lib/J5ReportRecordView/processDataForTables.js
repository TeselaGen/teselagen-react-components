...
var processJ5RunConstructs = function processJ5RunConstructs(j5RunConstructs) {
  return j5RunConstructs.filter(function (j5RunConstruct) {
    ...
    return _extends({}, j5RunConstruct, {
      ...
      partsContainedNames: (0, _lodash.get)(j5RunConstruct, "j5ConstructAssemblyPieces[0].assemblyPiece.j5AssemblyPieceParts[0].j5InputPart.sequencePart.name") && (0, _lodash.flatMap)(j5RunConstruct.j5ConstructAssemblyPieces, function (j5ConstructAssemblyPiece) {
