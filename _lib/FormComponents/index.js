...
function getIntent(_ref) {
  ...
  return (touched || showErrorIfUntouched) && error ? _core.Intent.DANGER : undefined;
}
...
function getIntentClass(_ref2) {
  ...
  return (touched || showErrorIfUntouched) && error ? _core.Classes.INTENT_DANGER : "";
}
...
var renderBlueprintTextarea = function renderBlueprintTextarea(props) {
  var input = props.input,
      ...
      _onKeyDown2 = _props$onKeyDown2 === undefined ? _lodash.noop : _props$onKeyDown2,
      rest = _objectWithoutProperties(props, ["input", "intentClass", "inputClassName", "onFieldSubmit", "onKeyDown"]);

  return _react2.default.createElement("textarea", _extends({}, removeUnwantedProps(rest), {
...
exports.renderBlueprintTextarea = renderBlueprintTextarea;
...
var renderReactSelect = function renderReactSelect(props) {
  ...
  return async ? _react2.default.createElement(_reactSelect2.default.Async, propsToUse) : _react2.default.createElement(_reactSelect2.default, propsToUse);
};
...
var renderSelect = function renderSelect(props) {
  ...
  return _react2.default.createElement(
    "div",
    { className: (0, _classnames2.default)(_core.Classes.SELECT, _core.Classes.FILL, className) },
...
var renderBlueprintRadioGroup = function renderBlueprintRadioGroup(_ref5) {
  ...
  return _react2.default.createElement(
    ...
    options.map(function (_ref6, index) {
      ...
      return _react2.default.createElement(_core.Radio, { key: index, value: value, label: label, disabled: disabled });
    })
  );
};
...
function generateField(component, opts) {
  ...
  return function FieldMaker(_ref7) {
    var name = _ref7.name,
        ...
        onFieldSubmit = _ref7$onFieldSubmit === undefined ? _lodash.noop : _ref7$onFieldSubmit,
